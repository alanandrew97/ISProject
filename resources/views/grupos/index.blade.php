          ...
          <ul class="collapsible">
            <li>
              ...
              <div class="collapsible-body" style="padding: 20px;">
                <a href="#modalGraficaGrupo" data-grahicData="{{ json_encode($grupo['data']) }}" class="modal-trigger modalGraficaGrupo"><i class="material-icons large">insert_chart</i>&nbsp;<h5>Ver gráfica</h5></a>
                <div>
