          ...
          <ul class="collapsible">
            <li>
              <div class="collapsible-header" style="position:relative;">
                ...
                <a href="#modalGraficaGrupo" data-graphic-data="{{json_encode($grupo['data'])}}" data-graphic-labels="{{json_encode($grupo['labels'])}}" class="modal-trigger modalGraficaGrupo"><i style="position:absolute;right:70px;" data-edificio-id="{{$grupo->id}}" class="material-icons right">insert_chart</i></a>
